...
#define DOTCLK_H_PULSE_WIDTH	128	/* Typ 128 */
#define DOTCLK_HF_PORCH		118
#define DOTCLK_HB_PORCH		90

#define DOTCLK_V_PULSE_WIDTH	25 /*10	/* Min/max 2/10 */
#define DOTCLK_VF_PORCH		10	/* Min 5 */
#define DOTCLK_VB_PORCH		10	/* Min 35 */
