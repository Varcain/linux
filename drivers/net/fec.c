...
#if  defined(CONFIG_CCARDXMX28_ENET0_LEDS) || defined(CONFIG_CCARDXMX28_ENET1_LEDS)
...
#if !defined(CONFIG_MODULE_CCXMX5X) && !defined(CONFIG_MODULE_CCARDXMX28)
	/* Reset all multicast.	*/
	writel(0, fep->hwp + FEC_GRP_HASH_TABLE_HIGH);
	writel(0, fep->hwp + FEC_GRP_HASH_TABLE_LOW);
#ifndef CONFIG_M5272
...
#endif
#endif /* !defined(MODULE_CCXMX5X) && !defined(CONFIG_MODULE_CCARDXMX28) */
