...
extern void ccwmx51_set_lcd_struct_from_bl_shared(nv_lcd_config_t *lcd_config);
#endif
				   ...
				   char **cmdline, struct meminfo *mi)
{
	...
	/* Identify 256MB variants to adjust pmem */
	if( total_mem == SZ_256M && bank_count==1 ){
		pmem_adsp_size = android_pmem_data.size = SZ_32M;
		pmem_gpu_size = android_pmem_gpu_data.size = SZ_32M;
...
#if defined(CONFIG_FB_MXC_SYNC_PANEL) || \
	defined(CONFIG_FB_MXC_SYNC_PANEL_MODULE)
	ccwmx51_set_lcd_struct_from_bl_shared(
