...
extern void mx28_ccardxmx28_eth_pins_deinit(void);

extern void ccardxmx28_set_mod_variant(u8 variant);
extern void ccardxmx28_set_mod_version(u8 revision);
u8 ccardxmx28_get_mod_version(void);
extern void ccardxmx28_set_mod_sn(u32 sn);
