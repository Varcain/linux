...
extern int ccxmx5x_total_mem, ccxmx5x_left_mem;
#endif
				       ...
				       unsigned long *zhole_size)
{
	 ...
	 */
	if (mxc_dma_zone_size > ccxmx5x_total_mem)
		mxc_dma_zone_size = ccxmx5x_total_mem;
#if defined(CONFIG_FB_MXC_SYNC_PANEL)
	if (mxc_dma_zone_size > ccxmx5x_left_mem)
		mxc_dma_zone_size = ccxmx5x_left_mem;
#endif
#endif
